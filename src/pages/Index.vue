<template>
  <q-page class="bg-white">
    <div class="row justify-center q-mt-sm">
      <q-btn class="text-white bg-purple-9 q-mt-md" style="width:80vw" @click="createAccount()" align="left" rounded icon="add_circle_outline" label="Create new account" />
    </div>
    <div class="row justify-center q-mt-md">
      <q-btn class="text-white bg-red-9" style="width:80vw" @click="importAccountDialog=true" outline rounded align="left" icon="account_circle" label="Import old account" />
    </div>
    <div class="row justify-center q-mt-xl">
      <q-btn class="text-white bg-blue q-mt-md" style="width:60vw" @click="openUrl('https://wallet.funcoin.io/')" rounded align="left" icon="info_outline" label="Web Wallet" />
    </div>
